...
#define CAN_FAN_MSG_ID              700     //message id for info from fan controller
...
char *fanMessages[] = { "Fan Low", "Fan High", "Fan Off", "Fan Temp Error" };
...
//generated by AutoCAN_Fan
const canSystemMessage canFanLow    =       {CAN_FAN_MSG_ID, 0, fanMessages[0])};
const canSystemMessage canFanHigh   =       {CAN_FAN_MSG_ID, 1, fanMessages[1])};
const canSystemMessage canFanOff    =       {CAN_FAN_MSG_ID, 2, fanMessages[2])};
const canSystemMessage canFanError  =       {CAN_FAN_MSG_ID, 3, fanMessages[3])};
...
EngineVariable engine_pw1   = {"PW1", "Bank 1 PW", 0.0, 0.0, 0.0, 20.0, 2, 0, 0, 0, 0};         //injector pulse width bank 1
EngineVariable engine_pw2   = {"PW2", "Bank 2 PW", 0.0, 0.0, 0.0, 20.0, 2, 0, 0, 0, 0};         //injector pulse width bank 2
