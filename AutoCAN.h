...
const canSystemMessage canEpas1 =           {CAN_INFO_MSG_ID, 200, epasModeDescriptions[0]};
const canSystemMessage canEpas2 =           {CAN_INFO_MSG_ID, 205, epasModeDescriptions[1]};
const canSystemMessage canEpas3 =           {CAN_INFO_MSG_ID, 210, epasModeDescriptions[2]};
const canSystemMessage canEpas4 =           {CAN_INFO_MSG_ID, 215, epasModeDescriptions[3]};
const canSystemMessage canEpas5 =           {CAN_INFO_MSG_ID, 220, epasModeDescriptions[4]};
const canSystemMessage canEpas6 =           {CAN_INFO_MSG_ID, 225, epasModeDescriptions[5]};
